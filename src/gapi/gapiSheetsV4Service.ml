  ...
  struct
    ...
    let batchGet
      ...
      let params = ValuesParameters.merge_parameters
        ?standard_parameters:std_params ?majorDimension ?ranges
    ...
    let get
      ...
      let full_url = GapiUtils.add_path_to_url ["v4"; "spreadsheets";
        ...
        base_url in
      let params = ValuesParameters.merge_parameters
        ?standard_parameters:std_params ?dateTimeRenderOption
        ?valueRenderOption ?majorDimension () in
      let query_parameters = GapiOption.map
        ValuesParameters.to_key_value_list params in
      GapiService.get ?query_parameters ?etag ?custom_headers full_url
    ...
    let update
      ...
      let full_url = GapiUtils.add_path_to_url ["v4"; "spreadsheets";
        ...
        base_url in
      let params = ValuesParameters.merge_parameters
        ?standard_parameters:std_params ?responseDateTimeRenderOption
        ?valueInputOption ?includeValuesInResponse ?responseValueRenderOption
        () in
      let query_parameters = GapiOption.map
        ValuesParameters.to_key_value_list params in
    ...
    let append
      ...
      let params = ValuesParameters.merge_parameters
        ?standard_parameters:std_params ?insertDataOption
